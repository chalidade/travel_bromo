  ...
  <div style="padding:20px;padding-left:100px;padding-right:100px;padding-bottom: 0px;">
    ...
    <div class="row">
      <div class="col s8 white" style="padding:20px;border-radius:10px;padding-left: 40px;">
        ...
        <input type="text" name="duration" value="Virtual Account" style="width:95%;margin-top:5px;background:#f5f5f5;border-radius:20px; padding-left:20px;font-size:10px;height: 30px;border: none;">
          ...
          <div class="col s12">
            ...
            <div style="width:98%;margin-top:5px;background:#f5f5f5;border-radius:20px; padding-left:20px;font-size:10px;height: 30px;border: none;">
              <table>
                <tr style="border:none">
                  ...
                  <td style="padding: 0px;padding-top: 7px;"><font style="font-weight: 800;">Bank Central Asia (BCA)</font></td>
                  <td style="padding: 0px;padding-top: 7px;"></td>
                </tr>
              </table>
            </div>
            <div style="width:98%;margin-top:5px;background:#f5f5f5;border-radius:20px; padding-left:20px;font-size:10px;height: 30px;border: none;">
              <table>
                <tr style="border:none">
                  <td style="padding: 0px;padding-top: 7px;"></td>
                  <td style="padding: 0px;padding-top: 7px;"><font style="font-weight: 800;">Bank Rakyat Indonesia (BRI)</font></td>
                  <td style="padding: 0px;padding-top: 7px;"></td>
                </tr>
              </table>
      ...
      <div class="col s3 white" style="padding:20px;border-radius:10px">
        ...
        <p style="font-size:12px">4551223</p>
      </div>
    </div>
  </div>
  ...
  <div style="padding:20px;padding-left:100px;padding-right:100px;padding-top: 0px;padding-bottom:0px">
    ...
    <div class="row">
      ...
      <table width="100%" style="font-size:12px">
        <tr>
          <td style="padding:0px;font-weight: 800;">Borobudur Temple Package x2</td>
          <td style="padding:0px;font-weight: 800;padding-right:20px;text-align:right">Rp 5.000.000</td>
        </tr>
        <tr style="border:none">
      ...
      <div style="padding:20px;padding-left:100px;padding-right:100px;padding-top: 20px;">
        ...
        <a href="order_done.php" type="button" class="light-blue accent-3" name="button" style="border:none;padding:10px;border-radius:30px;color:#fff;font-size:12px;padding-left: 40px;padding-right: 40px;">Pay Now</a>
      </div>
  </div>
</div>
