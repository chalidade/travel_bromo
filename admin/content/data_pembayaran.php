              ...
              <h3 class="box-title">Data Payment</h3>
                  ...
                  <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                    ...
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Payment Via</th>
                    ...
                    <tbody>
                      ...
                      <td class="">BCA Virtual Account</td>
                      <td class="">
                        <button type="button" class="btn btn-primary" name="button"> Confirm</button>
                        <button type="button" class="btn btn-success" name="button">Detail</button>
                      </td>
                    ...
                    <tr>
                      ...
                      <th rowspan="1" colspan="1">Payment Via</th>
